...
const DEFAULT_DATA = {
  "site": {
    ...
    "titleEn": "Professor Layton and the Strange Town",
    "navLabel": "레이튼 교수",
    "navSub": "와 이상한 마을",
    "tagline": "레이튼 교수",
    "disclaimer": "Professor Layton is a trademark of Level-5 Inc."
  },
  "hero": {
  ...
  "about": {
    ...
    "title": "이상한 마을의\n이야기",
    "paragraphs": [
      "레이튼 교수는 고고학자이자 신사, 그리고 세상에서 가장 탁월한 수수께끼 풀이사입니다. 그의 조수 루크와 함께, 그는 어디서든 수수께끼가 있는 곳이라면 반드시 찾아갑니다.",
      "게임 속 세계관을 현실로 옮겨온 다양한 작업물들을 만나보세요.",
  ...
  "puzzles": {
    ...
    "items": [
      ...
      },
      {
        ...
        "icon": "☕",
        "title": "카페의 암호 메뉴",
        "desc": "메뉴판 뒷면에 적힌 이상한 글씨. 해독의 열쇠는 의외의 곳에.",
        "status": "coming"
      },
      {
        "id": "p5",
